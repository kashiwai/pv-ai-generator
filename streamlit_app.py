"""
🎬 PV AI Generator v5.3.2 - Streamlit版
ステップバイステップワークフロー実装
1. 台本生成 → 2. Midjourney画像生成 → 3. Kling動画生成
PIAPI v1 API対応と画像生成修正
"""
...
# ページ設定
st.set_page_config(
    page_title="🎬 PV AI Generator v5.3.2",
    page_icon="🎬",
    layout="wide",
...
def main():
    ...
    with col1:
        st.info("🆕 **v5.3.2 アップデート**: PIAPI v1 API対応、画像生成修正！")
    with col2:
